    ...
    <div class="pb-20 my-5">
        ...
        <div>
            <div class="flex justify-center pt-4">
                <form action="{{ route('personnels.update', $personnels->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="block">
                        <div>
                        ...
                        <div>
                            ...
                            <img src="{{ asset('uploads/personnels/' . $personnels->images) }}" alt="I am A Pic"

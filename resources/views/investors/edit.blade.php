...
<div class="pb-20 my-5">
    ...
    <div>
        <div class="flex justify-center pt-4">
            {{ Form::model($investors,['route' => ['investor.update',$investors->id],'method'=>'PUT',
            'enctype'=>'multipart/form-data']) }}
            <div class="block">
                <div>
                    <label for="first_name" class="text-lg">First Name</label>
                    {!! Form::text('first_name',$investors->first_name,array('class' => 'form-control')) !!}
                ...
                <div>
                    ...
                    {!! Form::text('last_name',$investors->last_name,array('class' => 'form-control')) !!}
                ...
                <div>
                    ...
                    {!! Form::text('phone_number',$investors->phone_number,array('class' => 'form-control')) !!}
